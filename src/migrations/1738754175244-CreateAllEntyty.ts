...
export class CreateAllEntyty1738754175244 implements MigrationInterface {
    name = 'CreateAllEntyty1738754175244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "price" integer NOT NULL, "slug" character varying NOT NULL, "scores" integer NOT NULL, "code" integer NOT NULL, "discountPercentage" integer NOT NULL DEFAULT '15', "rating" integer NOT NULL DEFAULT '0', "voices" integer NOT NULL DEFAULT '0', "views" integer NOT NULL DEFAULT '0', "weigh" numeric NOT NULL DEFAULT '0.1', "reviews" text NOT NULL DEFAULT '', "visibility" boolean NOT NULL DEFAULT true, "favorites" boolean NOT NULL DEFAULT false, "image" character varying NOT NULL, "seoDescription" character varying NOT NULL DEFAULT '', "seoKeywords" character varying NOT NULL DEFAULT '', "seoCanonical" character varying NOT NULL DEFAULT '', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "categoriesId" integer, "brandsId" integer, CONSTRAINT "UQ_4c9fb58de893725258746385e16" UNIQUE ("name"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "categories_brands_brands" ("categoriesId" integer NOT NULL, "brandsId" integer NOT NULL, CONSTRAINT "PK_205f21fb464fc83801f0d2e1f15" PRIMARY KEY ("categoriesId", "brandsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_baae73092d54da2b3bad15488f" ON "categories_brands_brands" ("categoriesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8de5b1ca18da1960ed0664244d" ON "categories_brands_brands" ("brandsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "categories_brands_brands" ADD CONSTRAINT "FK_baae73092d54da2b3bad15488fa" FOREIGN KEY ("categoriesId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "categories_brands_brands" ADD CONSTRAINT "FK_8de5b1ca18da1960ed0664244d4" FOREIGN KEY ("brandsId") REFERENCES "brands"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "categories_brands_brands" DROP CONSTRAINT "FK_8de5b1ca18da1960ed0664244d4"`);
        await queryRunner.query(`ALTER TABLE "categories_brands_brands" DROP CONSTRAINT "FK_baae73092d54da2b3bad15488fa"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8de5b1ca18da1960ed0664244d"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_baae73092d54da2b3bad15488f"`);
        await queryRunner.query(`DROP TABLE "categories_brands_brands"`);
