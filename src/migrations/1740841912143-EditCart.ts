...
export class EditCart1740841912143 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`cart_item\` ADD \`orderId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`order\` ADD \`totalAmount\` decimal(10,2) NOT NULL DEFAULT '0.00'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`cart_item\` DROP FOREIGN KEY \`FK_26a8ff17b49cc3b5dcbdd7d357a\``);
        await queryRunner.query(`ALTER TABLE \`order\` DROP COLUMN \`totalAmount\``);
        await queryRunner.query(`ALTER TABLE \`order\` ADD \`totalAmount\` int NOT NULL`);
