...
export class CreateAllEntyty1739255386759 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`articles\` (\`id\` int NOT NULL AUTO_INCREMENT, \`slug\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` text NOT NULL DEFAULT '', \`image\` varchar(255) NOT NULL DEFAULT '', \`seoDescription\` varchar(255) NOT NULL DEFAULT '', \`seoKeywords\` varchar(255) NOT NULL DEFAULT '', \`body\` varchar(255) NOT NULL DEFAULT '', \`views\` int NOT NULL DEFAULT '0', \`visibility\` tinyint NOT NULL DEFAULT 1, \`favoritesCount\` int NOT NULL DEFAULT '0', \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_1123ff6815c5b8fec0ba9fec37\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`categories\` (\`id\` int NOT NULL AUTO_INCREMENT, \`slug\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` text NOT NULL DEFAULT '', \`image\` varchar(255) NOT NULL DEFAULT '', \`seoDescription\` varchar(255) NOT NULL DEFAULT '', \`seoKeywords\` varchar(255) NOT NULL DEFAULT '', \`mpath\` varchar(255) NULL DEFAULT '', \`parentId\` int NULL, UNIQUE INDEX \`IDX_420d9f679d41281f282f5bc7d0\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`brands\` (\`id\` int NOT NULL AUTO_INCREMENT, \`slug\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` text NOT NULL DEFAULT '', \`image\` varchar(255) NOT NULL DEFAULT '', \`seoDescription\` varchar(255) NOT NULL DEFAULT '', \`seoKeywords\` varchar(255) NOT NULL DEFAULT '', UNIQUE INDEX \`IDX_b15428f362be2200922952dc26\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`products\` (\`id\` int NOT NULL AUTO_INCREMENT, \`slug\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` text NOT NULL DEFAULT '', \`image\` varchar(255) NOT NULL DEFAULT '', \`seoDescription\` varchar(255) NOT NULL DEFAULT '', \`seoKeywords\` varchar(255) NOT NULL DEFAULT '', \`price\` int NOT NULL, \`scores\` int NOT NULL DEFAULT '0', \`code\` int NOT NULL DEFAULT '0', \`discountPercentage\` int NOT NULL DEFAULT '15', \`rating\` int NOT NULL DEFAULT '0', \`voices\` int NOT NULL DEFAULT '0', \`views\` int NOT NULL DEFAULT '0', \`weigh\` decimal NOT NULL DEFAULT '0', \`reviews\` text NOT NULL DEFAULT '', \`visibility\` tinyint NOT NULL DEFAULT 1, \`favoritesCount\` int NOT NULL DEFAULT '0', \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`categoriesId\` int NULL, \`brandsId\` int NULL, UNIQUE INDEX \`IDX_464f927ae360106b783ed0b410\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
